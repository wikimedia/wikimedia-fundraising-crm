 ...
 */
class CRM_Monolog_Upgrader_Base {

  /**
   * @var CRM_Monolog_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Monolog_Upgrader(
        'monolog',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Monolog_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Monolog_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
