...
return [
  ...
  'zendesk_api_user' => [
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => \CRM_ExchangeRates_ExtensionUtil::ts('API User for Zendesk API calls (found on Zendesk API settings page)'),
    'default' => 'zendesk_api_user',
    'title' => E::ts('Zendesk API User'),
    'help_text' => '',
    'html_type' => 'text',
    'settings_pages' => ['zendesk_settings' => ['weight' => 20]],
    ],
  'zendesk_api_password' => [
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => \CRM_ExchangeRates_ExtensionUtil::ts('API password for Zendesk API calls (found on Zendesk API settings page)'),
  ...
  'zendesk_url' => [
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => \CRM_ExchangeRates_ExtensionUtil::ts('URL of the WMF Zendesk instance'),
