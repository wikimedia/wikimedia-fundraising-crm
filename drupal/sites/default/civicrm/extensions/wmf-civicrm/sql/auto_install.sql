...
CREATE TABLE `civicrm_contribution_tracking` (
  ...
  `os` varchar(255) COMMENT 'Data pending - see pending T182039. Operating System',
  `os_version` varchar(255) COMMENT 'Data pending - see pending T182039. Operating System - Major Version',
  `browser` varchar(255) COMMENT 'Data pending - see pending T182039. Browser',
  `browser_version` varchar(255) COMMENT 'Data pending - see pending T182039. Browser Version',
  ...
  `utm_source` varchar(128) COMMENT 'UTM Source. This is the original text but is separately broken out into banner etc. We aspire to drop this field if we can be sure the data in it is clean enough to always capture in sub-fields',
  PRIMARY KEY (`id`),
