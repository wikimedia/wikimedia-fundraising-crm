...
$navigation = [
  ...
  [
    ...
    'params' => [
      'version' => 4,
      'values' => [
        'label' => E::ts('Drupal Users'),
        'name' => 'wmf_drupal_user',
        'url' => 'admin/people',
        'icon' => NULL,
        'permission' => 'administer CiviCRM',
        'permission_operator' => 'AND',
  ...
  [
    'name' => 'Navigation_WMF_Permissions',
    'entity' => 'Navigation',
    'cleanup' => 'always',
    'update' => 'unmodified',
    'params' => [
      'version' => 4,
      'values' => [
        'label' => E::ts('Drupal Permissions'),
        'name' => 'wmf_drupal_permission',
  ...
  [
    ...
    'params' => [
      'version' => 4,
      'values' => [
        'label' => E::ts('Drupal Roles'),
        'name' => 'wmf_drupal_role',
