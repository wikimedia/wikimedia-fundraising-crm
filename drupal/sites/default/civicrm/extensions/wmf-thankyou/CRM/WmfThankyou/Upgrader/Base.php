 ...
 */
class CRM_WmfThankyou_Upgrader_Base {

  /**
   * @var CRM_WmfThankyou_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_WmfThankyou_Upgrader(
        'wmf-thankyou',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_WmfThankyou_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_WmfThankyou_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
