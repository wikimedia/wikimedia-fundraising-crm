 ...
 */
function datachecks_civicrm_postInstall() {
  _datachecks_civix_civicrm_postInstall();
}
 ...
 */
function datachecks_civicrm_entityTypes(&$entityTypes) {
  _datachecks_civix_civicrm_entityTypes($entityTypes);
}
