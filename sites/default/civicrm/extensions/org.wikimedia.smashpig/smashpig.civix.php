 ...
 */
function _smashpig_civix_civicrm_xmlMenu(&$files) {
  foreach (_smashpig_civix_glob(__DIR__ . '/xml/Menu/*.xml') as $file) {
    $files[] = $file;
  }
}
 ...
 * @return array(string)
 */
function _smashpig_civix_find_files($dir, $pattern) {
  ...
  while (!empty($todos)) {
    ...
    foreach (_smashpig_civix_glob("$subdir/$pattern") as $match) {
      if (!is_dir($match)) {
        $result[] = $match;
      }
    }
 ...
 */
function _smashpig_civix_civicrm_managed(&$entities) {
  $mgdFiles = _smashpig_civix_find_files(__DIR__, '*.mgd.php');
  sort($mgdFiles);
 ...
 */
function _smashpig_civix_civicrm_caseTypes(&$caseTypes) {
  if (!is_dir(__DIR__ . '/xml/case')) {
    return;
  }

  foreach (_smashpig_civix_glob(__DIR__ . '/xml/case/*.xml') as $file) {
 ...
 */
function _smashpig_civix_civicrm_angularModules(&$angularModules) {
  if (!is_dir(__DIR__ . '/ang')) {
    return;
  }

  $files = _smashpig_civix_glob(__DIR__ . '/ang/*.ang.php');
 ...
 */
function _smashpig_civix_civicrm_themes(&$themes) {
  $files = _smashpig_civix_glob(__DIR__ . '/*.theme.php');
  foreach ($files as $file) {
 ...
 */
function _smashpig_civix_glob($pattern) {
  $result = glob($pattern);
 ...
 */
function _smashpig_civix_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
