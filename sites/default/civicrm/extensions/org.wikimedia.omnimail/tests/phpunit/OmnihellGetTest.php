...
class OmnihellGetTest extends OmnimailBaseTestClass {
  ...
  public function testOmnihellGet() {
    ...
    $this->assertEquals(["WHEN  (country is equal to ILAND IsoLang is equal to heAND latest_donation_date is before Jan 1, 2019AND EMAIL_DOMAIN_PART is not equal to one of the following (aol.com | netscape.com | netscape.net | cs.com | aim.com | wmconnect.com | verizon.net)OR  (Email is equal to fundraisingemail-jajp+heIL@wikimedia.orgAND country is equal to IL))AND Segment is equal to 2"], $hell);
  }
