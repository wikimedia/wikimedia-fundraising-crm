 ...
 *
 * Generated from /Users/eileenmcnaughton/buildkit/build/wmff/sites/default/civicrm/extensions/org.wikimedia.omnimail/xml/schema/CRM/Omnimail/MailingProviderData.xml
 * DO NOT EDIT.  Generated by CRM_Core_CodeGen
 * (GenCodeChecksum:adbefc69960375168772647903f18c1f)
 */
...
class CRM_Omnimail_DAO_MailingProviderData extends CRM_Core_DAO {
  ...
  public static function getEntityTitle() {
    return ts('Mailing Provider Datas');
  }
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'contact_identifier' => [
          ...
          'title' => CRM_Omnimail_ExtensionUtil::ts('Contact Identifier'),
          'description' => CRM_Omnimail_ExtensionUtil::ts('External reference for the contact'),
          'maxlength' => 255,
        ...
        'mailing_identifier' => [
          ...
          'type' => CRM_Utils_Type::T_STRING,
          'title' => CRM_Omnimail_ExtensionUtil::ts('Mailing Identifier'),
          'description' => CRM_Omnimail_ExtensionUtil::ts('External Reference for the mailing'),
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
        ...
        'email' => [
          'name' => 'email',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => CRM_Omnimail_ExtensionUtil::ts('Email'),
          'description' => CRM_Omnimail_ExtensionUtil::ts('Email Address'),
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
        ...
        'event_type' => [
          'name' => 'event_type',
          'type' => CRM_Utils_Type::T_STRING,
          'title' => CRM_Omnimail_ExtensionUtil::ts('Event Type'),
          'description' => CRM_Omnimail_ExtensionUtil::ts('Type of action'),
          'maxlength' => 255,
          'size' => CRM_Utils_Type::HUGE,
        ...
        'recipient_action_datetime' => [
          ...
          'title' => CRM_Omnimail_ExtensionUtil::ts('Recipient Action Datetime'),
          'description' => CRM_Omnimail_ExtensionUtil::ts('When the action happened'),
        ...
        'contact_id' => [
          ...
          'description' => CRM_Omnimail_ExtensionUtil::ts('Contact in CiviCRM'),
        ...
        'is_civicrm_updated' => [
          ...
          'description' => CRM_Omnimail_ExtensionUtil::ts('Has the action been synchronised through to CiviCRM'),
