...
$TYmsgs['nl'] = array(
	...
	"thank_you_to_name_secondary" => "vriend van de Wikimedia Foundation",
	"thank_you_subject" => "Dank u wel van de Wikimedia Foundation",
	"thank_you_unsubscribe_title" => "Uitschrijven van Wikimedia Foundation",
	"thank_you_unsubscribe_button" => "Uitschrijven",
//	"thank_you_unsubscribe_confirm" => "",
//	"thank_you_unsubscribe_warning" => "",
	"thank_you_unsubscribe_success" => "U bent niet langer ingeschreven op onze mailinglijst",
	"thank_you_unsubscribe_delay" => "Het duurt maximaal vier (4) dagen om deze wijzigingen door te voeren. In het geval u in de tussentijd nog e-mailberichten van ons ontvangt, bieden wij daar bij voorbaat onze excuses voor aan. Neem alstublieft contact op met <a href='mailto:donations@wikimedia.org'>donations@wikimedia.org</a> als u nog vragen hebt",
	"thank_you_unsubscribe_fail" => "Er is een fout opgetreden tijdens de verwerking. Neem alstublieft contact op met <a href='mailto:donations@wikimedia.org'>donations@wikimedia.org</a>.",
);
$TYmsgs['nl']['thank_you_body_plaintext'] =<<<'EOD'
...
$TYmsgs['nl']['thank_you_body_html'] =<<<'EOD'
<p>Beste {contact.first_name},</p>

<p>Hartelijk dank voor uw donatie aan de Wikimedia Foundation!</p>

<p>Op deze manier betalen we onze rekeningen: door mensen als u, die vijf, twintig of honderd euro geven. Mijn favoriete donatie van het afgelopen jaar was vijf pond van een klein Engels meisje. Ze had haar ouders overtuigd, zodat ze haar zakgeld mocht doneren. Mensen zoals u en haar maken het voor Wikipedia mogelijk om door te gaan met het beschikbaar stellen van gratis, eenvoudig te vinden en onbevooroordeelde informatie, voor iedereen ter wereld. Voor iedereen die helpt meebetalen en ook voor iedereen die zich dit niet kan veroorloven. Hartelijk bedankt.</p>

<p>Ik weet dat het gemakkelijk is om ons verzoek om donaties te negeren, maar ik ben blij dat u dat niet heeft gedaan. Ik zeg dit niet alleen namens mijzelf, maar ook namens de tienduizenden vrijwilligers die Wikipedia helpen schrijven: dank u dat u ons wilt helpen de wereld een beetje beter te maken. We zullen uw geld zorgvuldig gebruiken.</p>

<p>Dank u voor uw vertrouwen in ons.</p>

<p>Bedankt,<br />
<br />
<b>Sue Gardner</b><br />
Directeur van de Wikimedia Foundation</p>
...
<p>Wij willen u als donateur graag op de hoogte te houden van de activiteiten van de Wikipediagemeenschap en de fondsenwerving. Als u dergelijke e-mails niet op prijs stelt, klik dan hieronder en we verwijderen uw e-mailadres van de maillijst.</p>
<a style="padding-left: 25px;" href="{unsubscribe_link}">Uitschrijven</a>
</div>
EOD;
