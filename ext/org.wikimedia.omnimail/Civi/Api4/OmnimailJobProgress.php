...
use Civi\Api4\Action\OmnimailJobProgress\Check;
...
class OmnimailJobProgress extends Generic\DAOEntity {
  ...
  public static function check ($checkPermissions = TRUE): Action\OmnimailJobProgress\Check {
    return (new Check(__CLASS__, __FUNCTION__))
   ...
   * OmnimailJobProgress Check.
   *
   * @return \Civi\Api4\Action\OmnimailJobProgress\CheckStatus   *
   * @param bool $checkPermissions
   *
   * @throws \CRM_Core_Exception
   */
  public static function checkStatus ($checkPermissions = TRUE): Action\OmnimailJobProgress\CheckStatus {
    return (new CheckStatus(__CLASS__, __FUNCTION__))
      ->setCheckPermissions($checkPermissions);
  }
