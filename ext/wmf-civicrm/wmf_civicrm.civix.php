...
function _wmf_civicrm_civix_class_loader($class) {
  ...
  if (strpos($class, 'CiviMix\\Schema\\WmfCivicrm\\') === 0) {
 ...
 */
function _wmf_civicrm_civix_civicrm_enable(): void {
  _wmf_civicrm_civix_civicrm_config();
  // Based on <compatibility>, this does not currently require mixin/polyfill.php.
}
