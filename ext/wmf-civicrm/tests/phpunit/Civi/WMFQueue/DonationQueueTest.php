...
class DonationQueueTest extends BaseQueueTestCase {
   ...
   * @throws \CRM_Core_Exception
   */
  public function testDonationBadContactID(): void {
    $message = $this->processDonationMessage([
      'gross' => 400,
      ...
      'Maximal contribution' => [
        ...
        'expected' => [
          'contact' => [
            ...
            'wmf_donor.all_funds_total_2023' => 0,
            'wmf_donor.all_funds_total_2024' => 1.23,
            'wmf_donor.number_donations' => 1,
            'wmf_donor.first_donation_date' => '2024-03-01 00:00:00',
            'wmf_donor.all_funds_last_donation_date' => '2024-03-01 00:00:00',
            'wmf_donor.last_donation_usd' => '1.23',
            'wmf_donor.lifetime_including_endowment' => '1.23',
            'wmf_donor.all_funds_total_2023_2024' => 1.23,
          ],
          'contribution' => [
            'address_id' => '',
            'amount_level' => '',
