...
return [
  [
    'name' => 'UserJob_import_Endowment_Overflow_stock_import',
    'entity' => 'UserJob',
    'cleanup' => 'unused',
    'update' => 'unmodified',
    'params' => [
      'version' => 4,
      'values' => [
        'name' => 'import_Endowment Overflow stock import',
        'status_id' => 2,
        ...
        'metadata' => [
          ...
          'entity_configuration' => [
            ...
            'Contact' => [
              ...
              'dedupe_rule' => [
                'Individual_Unsupervised_Name_and_address_General__1',
              ],
            ],
            'SoftCreditContact' => [
              'contact_type' => 'Individual',
