...
return [
  ...
  [
    'name' => 'OptionValue_BatchStatus_TotalManuallyEntered',
    'entity' => 'OptionValue',
    'cleanup' => 'unused',
    'update' => 'unmodified',
    'params' => [
      ...
      'values' => [
        ...
        'value' => 9,
        'name' => 'total_manually_entered',
        'filter' => 1,
        'is_default' => FALSE,
        'description' => 'Batch created via the manual finance batch form, awaiting batch data entry or import completion',
        'is_optgroup' => FALSE,
        'is_reserved' => TRUE,
        'is_active' => TRUE,
        'component_id' => NULL,
