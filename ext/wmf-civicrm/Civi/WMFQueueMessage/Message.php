  ...
  public function getAvailableFields(): array {
    ...
    $fields = [
      ...
      'original_matching_gift_fee_amount' => [
        'name' => 'original_matching_gift_fee_amount',
        'data_type' => 'Float',
        'label' => E::ts('Fee Amount given by matching gift entity (e.g. employer) in the original currency'),
        'used_for' => 'audit message, offline gifts',
      ],
      'original_matching_gift_net_amount' => [
        'name' => 'original_matching_gift_net_amount',
        'data_type' => 'Float',
        'label' => E::ts('Net Amount given by matching gift entity (e.g. employer) in the original currency'),
        'used_for' => 'audit message, offline gifts',
      ],
      ...
      'original_individual_gift_net_amount' => [
        'name' => 'original_individual_gift_net_amount',
        'data_type' => 'Float',
        'label' => E::ts('Net Amount given by the individual expecting to be matched in the original currency'),
        'used_for' => 'audit message, offline gifts',
      ],
      'original_individual_gift_fee_amount' => [
        'name' => 'original_individual_gift_fee_amount',
        'data_type' => 'Float',
        'label' => E::ts('Fee Amount given by the individual expecting to be matched in the original currency'),
        'used_for' => 'audit message, offline gifts',
      ],
      'settled_matching_gift_total_amount' => [
        'name' => 'settled_matching_gift_total_amount',
        'data_type' => 'Float',
        'label' => E::ts('Amount given by matching gift entity (e.g. employer) in the settled currency'),
        'used_for' => 'audit message, offline gifts',
      ],
      'settled_matching_gift_fee_amount' => [
        'name' => 'settled_matching_gift_fee_amount',
        'data_type' => 'Float',
        'label' => E::ts('Fee Amount given by matching gift entity (e.g. employer) in the settled currency'),
        'used_for' => 'audit message, offline gifts',
      ],
      'settled_matching_gift_net_amount' => [
        'name' => 'settled_matching_gift_net_amount',
        'data_type' => 'Float',
        'label' => E::ts('Net Amount given by matching gift entity (e.g. employer) in the settled currency'),
        'used_for' => 'audit message, offline gifts',
      ],
      'settled_individual_gift_total_amount' => [
        'name' => 'settled_individual_gift_total_amount',
        'data_type' => 'Float',
        'label' => E::ts('Amount given by the individual expecting to be matched in the settled currency'),
        'used_for' => 'audit message, offline gifts',
      ],
      'settled_individual_gift_net_amount' => [
        'name' => 'settled_individual_gift_net_amount',
        'data_type' => 'Float',
        'label' => E::ts('Net Amount given by the individual expecting to be matched in the settled currency'),
        'used_for' => 'audit message, offline gifts',
      ],
      'settled_individual_gift_fee_amount' => [
        'name' => 'settled_individual_gift_fee_amount',
        'data_type' => 'Float',
        'label' => E::ts('Fee Amount given by the individual expecting to be matched in the settled currency'),
        'used_for' => 'audit message, offline gifts',
      ],
    ];
