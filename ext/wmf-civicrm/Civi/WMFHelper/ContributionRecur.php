...
class ContributionRecur {
  ...
  public static function getUpgradeableWithoutChecksum(int $contact_id) {
    ...
    $contribution_recurs = \Civi\Api4\ContributionRecur::get(FALSE)
      ->addSelect('id', 'currency', 'amount', 'next_sched_contribution_date', 'contact.first_name', 'contact.last_name', 'contact.display_name', 'country.iso_code')
  ...
  public static function sendSuccessThankYouMail(array $contributionRecur, int $contributionId) {
    ...
    $context = [
      ...
      'recipient_address' => $sendResult['email'],
    ];
