...
class Contribution {
  ...
  /**
   * Gets a link to the processor console for a specific WMF transaction ID,
   * e.g. RECURRING ADYEN HWVPD7VKHS5H3275
   * @param string $transactionID
   * @return string|null
   */
  public static function getURLForTransactionID(string $transactionID): ?string {
    try {
      $transaction = WMFTransaction::from_unique_id($transactionID);
      ...
      // Suppress errors in case of e.g. trxn_id not generated by our queue import code
      return NULL;
    }
  }
   ...
   * @throws \CRM_Core_Exception
   */
  public static function updateCancelledContribution(DonationModifyMessage $message): void {
