...
use \Civi\Api4\Action\DAFGift\Queue;
use Civi\Api4\Action\DAFGift\Save;
 ...
 * @package Civi\Api4
 */
class DAFGift extends AbstractEntity {
   ...
   *
   * @return \Civi\Api4\Action\DAFGift\Queue
   */
   ...
   * @param bool $checkPermissions
   *
   * @return \Civi\Api4\Action\DAFGift\Save
   */
  ...
  public static function getFields(bool $checkPermissions = TRUE): BasicGetFieldsAction {
    return (new Generic\BasicGetFieldsAction(__CLASS__, __FUNCTION__, function() {
      return [
        ...
        'banking_institution' => ['name' => 'banking_institution'],
      ];
    }))->setCheckPermissions($checkPermissions);
  }
