...
return [
  ...
  'deduper_clean_location_types_to_keep_email' => [
    'name' => 'deduper_clean_location_types_to_keep_email',
    'type' => 'Array',
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => E::ts('Email location types to keep when non-primary, even when they duplicate another email'),
    'default' => [],
    'title' => E::ts('Email location types to keep when cleaning'),
    'help_text' => '',
    'html_type' => 'select',
    'html_attributes' => [
      'class' => 'crm-select2',
    ...
    'settings_pages' => ['deduper' => ['weight' => 75]],
    'pseudoconstant' => [
  ...
  'deduper_clean_location_types_to_keep_phone' => [
    'name' => 'deduper_clean_location_types_to_keep_phone',
    'type' => 'Array',
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => E::ts('Phone location types to keep when non-primary, even when they duplicate another phone'),
    'default' => [],
    'title' => E::ts('Phone location types to keep when cleaning'),
    'help_text' => '',
    'html_type' => 'select',
    'html_attributes' => [
      'class' => 'crm-select2',
    ...
    'settings_pages' => ['deduper' => ['weight' => 76]],
    'pseudoconstant' => [
      'table' => 'civicrm_location_type',
      'keyColumn' => 'name',
      'labelColumn' => 'display_name',
  ...
  'deduper_clean_location_types_to_keep_address' => [
    'name' => 'deduper_clean_location_types_to_keep_address',
    'type' => 'Array',
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => E::ts('Address location types to keep when non-primary, even when they duplicate another address'),
    'default' => [],
    'title' => E::ts('Address location types to keep when cleaning'),
    'help_text' => '',
    'html_type' => 'select',
    'html_attributes' => [
      'class' => 'crm-select2',
    ...
    'settings_pages' => ['deduper' => ['weight' => 77]],
    'pseudoconstant' => [
      'table' => 'civicrm_location_type',
      'keyColumn' => 'name',
      'labelColumn' => 'display_name',
