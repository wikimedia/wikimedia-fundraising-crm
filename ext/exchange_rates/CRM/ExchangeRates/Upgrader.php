 ...
 */
class CRM_ExchangeRates_Upgrader extends CRM_Extension_Upgrader_Base {
  ...
  /**
   * Upgrade 1001 - install civicrm_exchange_rate table
   * @return bool
   */
  public function upgrade_1001(): bool {
    $this->ctx->log->info('Applying update 1001 - install civicrm_exchange_rate table.');
    if (!CRM_Core_DAO::singleValueQuery("SHOW TABLES LIKE 'civicrm_exchange_rate'")) {
