...
return [
  ...
  'wmf_double_opt_in_from_address' => [
    ...
    'default' => 'no-response@wikimedia.org',
    'type' => 'String',
    'is_domain' => 1,
    'is_contact' => 0,
  ...
  'wmf_double_opt_in_lead_gen_from_name' => [
    'group_name' => 'WMF Thank You Settings',
    'group' => 'wmf-thankyou',
    'name' => 'wmf_double_opt_in_lead_gen_from_name',
    'default' => 'Wikimedia Foundation',
    'type' => 'String',
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => E::ts('Double opt-in - leadgen from name'),
    'help_text' => '',
    'html_type' => 'text',
    'html_attributes' => [
      'size' => 80,
  ...
  'wmf_double_opt_in_lead_gen_from_address' => [
    'group_name' => 'WMF Thank You Settings',
    'group' => 'wmf-thankyou',
    'name' => 'wmf_double_opt_in_lead_gen_from_address',
    'default' => 'no-response@wikimedia.org',
    'type' => 'String',
    'is_domain' => 1,
    'is_contact' => 0,
    'title' => E::ts('Double opt-in - leadgen from address'),
    'help_text' => '',
    'html_type' => 'text',
    'html_attributes' => [
      'size' => 80,
