...
return [
  ...
  [
    'name' => 'CustomGroup_Contribution_Recur_SmashPig_CustomField_Payment_Service_Id',
    'entity' => 'CustomField',
    'cleanup' => 'never',
    'update' => 'unmodified',
    'params' => [
      ...
      'values' => [
        ...
        'is_searchable' => TRUE,
        'is_search_range' => FALSE,
        'help_pre' => 'Gravy payment service connection UUID from the initial authorization. Sent back on subsequent charges so Gravy routes through the same processor.',
        'help_post' => NULL,
        'mask' => NULL,
        'attributes' => NULL,
        'javascript' => NULL,
        ...
        'note_columns' => 60,
        'note_rows' => 4,
        'column_name' => 'payment_service_id',
        'option_group_id' => NULL,
        'serialize' => 0,
        'filter' => NULL,
        'in_selector' => FALSE,
