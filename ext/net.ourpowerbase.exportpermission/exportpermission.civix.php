 ...
 * missing them.
 */
function _exportpermission_civix_fixNavigationMenu(&$nodes) {
  $maxNavID = 1;
  ...
  _exportpermission_civix_fixNavigationMenuItems($nodes, $maxNavID, NULL);
}

function _exportpermission_civix_fixNavigationMenuItems(&$nodes, &$maxNavID, $parentID) {
